...
| # | 类型 | 问句 | 期望意图 | 期望命中 |
|---|------|------|----------|----------|
| 1 | stock | 冻干精华液 20支装 还有多少？ | stock（精确 1 规格） | exact=1 |
| 2 | stock | 冻干精华液还有多少？ | stock（模糊 4 规格） | fuzzy=4 |
...
| 输入 | 期望 |
|------|------|
| 冻干 | 精确 0 + 模糊 4（冻干精华液 20支装/5支装/单支装/30支装） |
...
- 命中产品后回答表行数 = 精确命中 + 模糊命中去重（如「冻干精华液 20支装 还有多少？」→ 精确 1 + 模糊 3 = 4 行，精确行在前）。
